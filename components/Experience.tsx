...
export function Experience({ data }: { data: ExperienceItem[] }) {
  ...
  return (
    <section
      id="experience"
      className="py-32 px-6 md:px-12 max-w-5xl mx-auto border-t border-border/50"
      ref={containerRef}
    >
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <p className="text-muted-foreground font-serif italic text-xl mb-6">
                    {exp.company}
                  </p>
                  ...
                  <div
                    className={`flex flex-wrap gap-3 ${isEven ? 'justify-start' : 'md:justify-end justify-start'}`}
                  >
